        ...
        const init = () => {
            ...
            mm.add(isDesktop, () => 
            {
                ...
                const mask1 = () => {
                    ...
                    const bg1 = "linear-gradient(180deg, #fff 26.43%, rgba(255, 255, 255, 0) 34.39%, rgba(255, 255, 255, 0) 66.46%, #fff 87.03%)";
                    const bg2 = "linear-gradient(180deg, #fff 18.22%, rgba(255, 255, 255, 0) 21.58%, rgba(255, 255, 255, 0) 61.38%, #fff 76.86%)";
